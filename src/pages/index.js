      ...
      <div className="section-text-container section-left-border">
        ...
        <div className="section-body-container">
          ...
          <div className="item-copy-container">
            ...
            <p>
              Want to quickly sort yourself into a Hogwarts House on Slack? Type
              your the <code>/sortinghat</code> slash command followed by a name
              of the witch or wizard to be sorted. Sorting Hat bot responds with
              a short rhyme and the banner of the selected House.
            </p>
          </div>
          <div className="item-copy-container">
            <h3 className="item-title">
          ...
          <div className="item-copy-container">
            ...
            <p>
              dB NYC is a visualization of the noise pollution in New York City.
              The app was created using Ruby on Rails and maps the location of
              311 noise complaints, emergency services, social check-ins, and
              social venue reviews to create a dynamic heat-map of noise broken
          ...
          <div className="item-copy-container">
            ...
            <p>
              ...
              development at the two largest University of Texas archives over
              time. Wrote jQuery scraper to collect data from University XML
              documents and RegEx parser to normalize data.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="section-text-container section-left-border">
        ...
        <div className="section-body-container">
          ...
          <div className="item-copy-container">
            ...
            <p>
              {" "}
              Slides from a talk I gave to the Analytics Club at the Department
              of Education on how to approach data visualization and design when
